...
def preprocess(text):
    ...
    # Esse trecho do código retorna todos os tokens (palavras) que contenham apenas letras e números
    # Eliminando pontuação, letras especiais e outras coisas que podem gerar ruidos
    return [word for word in tokens if word.isalnum()]


# E esse trecho reune os tokens em um string ao texto original, porém sem pontuação, caracteres especiais e etc.
